...
description: EUR_JPY + GBP_JPY Long-only戦略の安定運用について
---
...
**2,191日間（約6年）のバックテスト検証**で、2通貨ペア（GBP_JPY + EUR_JPY）ともに**破産確率0%**を達成。2026年1月20日からPractice mode（最小ロット）で実運用を開始しました。
...
2通貨ペアをPhase 5-2（Practice mode）に移行するための5つの基準:
...
```
2026-01-20 ～ 2026-04-20: Phase 5-2 Practice mode（3ヶ月）
...
/opt/anaconda3/envs/st312/bin/python \
  /Users/htada/systemtrade/_fxTradingEngine/execution/main_gmo_live.py \
  --mode practice \
